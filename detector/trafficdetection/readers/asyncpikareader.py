...
class AsyncPikaReader(object):
    ...
    ROUTING_KEY = "streams"
    QUEUE = "batchedstreams"  # makes randomly named queue
    ...
    def on_channel_closed(self, channel, reason):
        ...
        violates the protocol, such as re-declare an exchange or AsyncPikaReader with
    ...
    def on_queue_declareok(self, frame, userdata):
